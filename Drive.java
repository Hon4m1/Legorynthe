...
public class Drive implements Observer{
	...
	public void update(Observable o, Object arg) {
        ...
        {       
                ...
                else if(s.distanceLeft <= 0.05 ) {
                	if(moteurDroit.isMoving()) {
						moteurDroit.stop();
					}
                ...
                else if(s.distanceRight <= 0.05 ) {
					if(moteurGauche.isMoving()) {
						moteurGauche.stop();
					}
	...
	public void decidePress() {
		stop();
		if(sensor.distanceRight > sensor.distanceLeft) {
			quartDeTourDroite();
		}else if(sensor.distanceRight <  sensor.distanceLeft) {
			quartDeTourGauche();
		}else {
			demiTour();
		}
